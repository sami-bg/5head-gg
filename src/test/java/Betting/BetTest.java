...
public class BetTest {
	...
	public void testBet() {
		Bet testBet;
		testBet = new Bet("hash", "testUser", 52, 0.52, "Aatrox", new TestGainFunction(), "testType", "10.9");
	...
	public void testBet1() {
		Bet testBet1;
		testBet1 = new Bet("hash", "testUser", 68, 1.365, "erg", new TestGainFunction(), "testType", "10.9");
